...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--arch', default='vit_base_patch16_224.dino', type=str,
    ...
    parser.add_argument('--output_dir', default="./logs/pleiades/vit", type=str, help='Path to save logs and checkpoints.')
